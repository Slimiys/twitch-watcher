...
(function initDashboardI18n(global) {
    ...
    const MESSAGES = {
        ru: {
            ...
            'streamers.favoriteHint': 'Избранные стримеры всегда видны в списке; офлайн — внизу таблицы.',
        ...
        en: {
            ...
            'streamers.favoriteHint': 'Favorite streamers stay visible; offline favorites appear at the bottom.',
