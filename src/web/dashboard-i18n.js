...
(function initDashboardI18n(global) {
    ...
    const MESSAGES = {
        ru: {
            ...
            'col.favorite': 'Избранное',
            'col.favoriteTitle': 'Избранные стримеры',
            'col.favoriteAdd': 'Добавить в избранное',
            'col.favoriteRemove': 'Убрать из избранного',
            'streamers.favoriteHint': 'Избранные стримеры всегда видны в списке; офлайн избранные — первыми среди офлайн.',
        ...
        en: {
            ...
            'col.favoriteTitle': 'Favorite streamers',
            'col.favoriteAdd': 'Add to favorites',
            'col.favoriteRemove': 'Remove from favorites',
            'streamers.favoriteHint': 'Favorite streamers stay visible; offline favorites appear first among offline.',
