...
export const APP_SETTING_FIELDS: AppSettingFieldMeta[] = [
  {
    ...
    section: 'Авторизация',
    inputType: 'password',
    hint: 'Cookie auth-token из браузера. Сохраняется в config.json.',
  ...
  {
    key: 'TWITCH_USER_ID',
    label: 'User ID (Docker, опционально)',
    section: 'Twitch',
    inputType: 'text',
  },
  {
  ...
  },
  {
    ...
    label: 'Client-Integrity (manual)',
    section: 'Client-Integrity',
    inputType: 'password',
    hint: 'Из DevTools → gql → Request Headers',
  },
  {
    key: 'TWITCH_CLIENT_INTEGRITY_EXPIRES',
    label: 'Срок integrity (unix sec/ms)',
    section: 'Client-Integrity',
    inputType: 'text',
  },
  {
    key: 'TWITCH_INTEGRITY_FALLBACK_API',
    label: 'Fallback POST /integrity при manual',
    section: 'Client-Integrity',
    inputType: 'boolean',
  },
  {
  ...
  },
  {
    ...
    inputType: 'select',
    options: [
      { value: '', label: 'по умолчанию (Docker)' },
