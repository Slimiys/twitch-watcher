...
На дашборде бота (секция **Статус бота**) кнопка **Запросить Client-Integrity** отправляет запрос в расширение: обновляется вкладка twitch.tv, токен передаётся в бот.
